      ...
      <v-col cols="12" md="6">
        <v-card>
          <v-card-text>
            ...
            <base-material-alert v-for="color2 in colors" :key="color2" :color="color2" dark dismissible>
              <span class="text-uppercase" v-text="color2" />
              — This is a regular alert made with the color of "{{ color2 }}"
            </base-material-alert>
        ...
        <v-card-text class="body-1 text-center">
          <v-row>
            ...
            <v-col class="hidden-sm-and-down" md="4">
              <v-sheet>
                <v-img src="https://picsum.photos/200/100" height="100" width="200" />
              </v-sheet>
            </v-col>
